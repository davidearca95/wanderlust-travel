        ...
        {!searchQuery && (
          <View style={styles.featuredContainer}>
            <FeaturedCard
              ...
              onPress={() => navigation.navigate('Destination', { destinationId: destinations[0].id })}
            />
          </View>
        )}
        ...
        <View style={styles.grid}>
          {filteredDestinations.map((dest) => (
            <TouchableOpacity
              ...
              style={styles.tile}
              activeOpacity={0.85}
              onPress={() => navigation.navigate('Destination', { destinationId: dest.id })}
            >
              ...
              <View style={styles.tileBadge}>
                <Text style={styles.tileBadgeText}>{dest.budgetPerDay.split('/')[0].replace('€', '€')}</Text>
              </View>
            </TouchableOpacity>
          ))}
        </View>
